                    ...
                    <div class="mt-3 col-lg-3 col-md-12 mb-4 mb-lg-0">
                      <!-- Image -->
                        ...
                        <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                          <img src="{{url('')}}/{{ $cart->product_image }}"
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                    ...
                    <button type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
                      title="Remove item" onclick="this.alert=('this is deleted')">
                      <i class="fas fa-trash"><img src="https://img.icons8.com/material-rounded/24/null/delete.png"/></i>
                    </button>
                  ...
                  <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    ...
                    <div class="d-flex mb-4" style="max-width: 300px">
                      <button class="btn btn-primary btn-sm me-1 mb-2 px-3 me-2"
                      ...
                      <button class="btn btn-primary btn-sm me-1 mb-2 px-3 ms-2"
      ...
      <div class="row d-flex justify-content-center my-4 bg-light">
        <div class="col-md-8 mt-3 mb-3 ">
          <div class="card mb-4 border-primary">
            ...
            <div class="card-body">
                  <!-- Single item -->
                @foreach($new_pet_item as $pet_item)
                    @php
                      $petData = json_decode($new_pet_item->pet_data, true);
                      // @dd($new_pet_item);
                    @endphp
                  <div id="cart-item" class="row bg-light">
                    ...
                    <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                      <!-- Data -->
                        ...
                        <form action="{{ route('destroypet',  $new_pet_item->id) }}" method="POST">
                          @csrf
                          @method('DELETE')
                          <button id="cartdelete" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
                            title="Remove item" href="{{route('destroypet', $new_pet_item->id)}} ">
                            <i class="fas fa-trash"  ><img src="https://img.icons8.com/material-rounded/24/null/delete.png"/></i>
                          </button>
                        </form>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                      ...
                      <!-- Price -->
                      <p class="text-start text-md-center">
                        <strong>Final Price :-  {{ $petData['pet_price'] }} </strong>
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                <li
                  class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
                  Pet
                  <span id="total-price" class="coolPrice" >₹ {{ $petData['pet_price'] }}</span>
                ...
                <li
                  ...
                  <span id="total-price" class="coolPrice" ><strong  >₹ {{ $petData['pet_price'] }} </strong></span>
                  <input type="hidden" name="final-Price" id="final-price" value="total-price" >

                </li>
              </ul>
              <form action="{{ route('petbuy',$new_pet_item->id)}}" method="POST" >
                <input type="hidden" name="plan" id="plan" value="{{ $new_pet_item->id }}">
                @csrf
